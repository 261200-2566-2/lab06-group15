public class Warrior implements Character{
     ...
     * effects: if character is on guarded, character can't attack.
    ...
    /** Guard
     * effects: make this character in guarded state(double defense and can't attack)
     * effects: print "character is already on guard!" if character is in guard state and user use guard again
     */
    public void guard(){
        if(!guarded){
            guarded = true;
     ...
     * effects: make this character out of guarded state(double defense and can't attack)
     * effects: print "character isn't on guard!" if character isn't in guard state and user use unGuard
     */
    public void unGuard(){
        if (guarded) {
            guarded = false;
