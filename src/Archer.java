public class Archer {
    ...
    /** Archer special move, Penetrate Attack (4 method() for each character classes)
     * effects: decrease opponent hp by the damage calculated with opponent remaining defense(calculated with penetration stat)
     * effects: if attack successfully print damage given and opponent's remaining hp
     * effects: if attacker is dead, attacker can't attack.
     * effects: if opponent is dead, opponent can't be attacked.
     * @param opponent the opponent you want to attack
     */
